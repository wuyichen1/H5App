<template>
  <div class="agreement-page">
    ...
    <div class="agreement-content">
      ...
      <h1>Seicos Privacy Policy</h1>
      <p class="update-time">Last updated: 2026</p>

      <p>
        Welcome to <strong>Seicos</strong>. Your privacy is very important to us.
        This Privacy Policy explains how Seicos collects, uses, and protects
      ...
      <ul>
        <li>Provide and improve Seicos services</li>
      ...
      <p>
        Seicos does not sell or rent your personal information. We may share
      ...
      <p>
        Seicos is not intended for individuals under the age required by
      ...
      <p>
        Seicos may update this Privacy Policy from time to time.
      ...
      <p>
        ...
        provided within the Seicos application.
      </p>
